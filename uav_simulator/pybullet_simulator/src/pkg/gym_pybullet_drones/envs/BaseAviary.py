...
class BaseAviary(gym.Env):
    ...
    def _housekeeping(self):
        ...
        urdf_relative_path = os.path.join(os.path.dirname(__file__), '..', 'assets', self.URDF)
        file_name = os.path.normpath(urdf_relative_path)
        self.DRONE_IDS = np.array([p.loadURDF(file_name,
                                              self.INIT_XYZS[i,:],
    ...
    def _getDroneImages(self,
        ...
        # print("Elapsed time for getCameraImage", time.time()-start_time)
    ...
    def _parseURDFParameters(self):
        ...
        """
        # file_name = pkg_resources.resource_filename('gym_pybullet_drones', 'assets/'+self.URDF)
        current_file_path = os.path.dirname(__file__)
        urdf_relative_path = os.path.join(current_file_path, '..', 'assets', self.URDF)
        file_name = os.path.normpath(urdf_relative_path)
        print("[INFO] BaseAviary._parseURDFParameters() ——— parsing file: ", file_name)
